...
import LiveDropSidebar from "../micro/LiveDropSidebar";
        ...
        <div className="autoheight w-full">
          <div className="footer flex flex-row items-center justify-between gap-5 rounded-t-[12px] border-b-[1px] border-[#2C3034] bg-[#1A1D20] px-8 py-4">
            <div className="mx-auto flex items-center gap-2 pl-[30px]">
              <span className="text-2xl font-bold text-[#DFDFDF]">Affiliates</span>
            </div>
          </div>
          <div
          ...
          >
            <div className="mt-8 rounded-xl bg-gradient-to-b from-red-700 to-gray-900 pl-1 pr-1 pt-1 text-white">
              <div
                className="flex w-full flex-col items-center justify-center rounded-xl md:flex-row  "
            ...
            <div className="mb-5 grid grid-cols-2 gap-4 md:mb-10">
              <div className="flex basis-[50%] gap-2 rounded-xl border border-[#2C3034] px-4 py-6 md:gap-4 md:px-9 md:py-8">
              ...
              <div className="flex basis-[50%] gap-2 rounded-xl border border-[#2C3034] px-4 py-6 md:gap-4 md:px-9 md:py-8">
                <div className="flex flex-row">
                  <div className="flex flex-row items-center justify-center">
                    <img
                      src={RedDollar}
                      alt="red-dollar-svg-icon"
                      className="h-auto w-[24px] min-w-[24px] md:w-[48px]"
                    />
                  </div>
                </div>
                <div className="flex flex-col gap-2">
              ...
              <div className="flex basis-[50%] items-center gap-2 rounded-xl border border-[#2C3034] px-4 py-6 md:gap-4 md:px-9 md:py-8">
                <div className="flex flex-row">
                  <div className="flex flex-row items-center justify-center">
                    <img
                      src={RedDollar}
                ...
                <div className="flex flex-col gap-2">
                  <h1 className="text-xs font-semibold text-[#848B8D] sm:text-sm md:text-base">
                    {" "}
            ...
            <div className="pointer-events-none absolute bottom-0 left-0 h-[66px] w-full bg-gradient-to-b from-transparent to-[#151719]"></div>
          </div>
        </div>
      </div>
      <Chat />
