...
const ProfileSideBar: React.FC = () => {
  ...
  return (
    <div className=" flex  flex-shrink-0 justify-center overflow-y-hidden rounded-xl bg-custom_black_2 xs:mx-6 xs:my-8 xs:min-h-[320px] 2xl:mb-0 2xl:ml-[52px] 2xl:mt-[52px] 2xl:h-auto 2xl:w-[392px]">
      <div
