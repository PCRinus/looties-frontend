    ...
    const AddCoins = () => {
        ...
        return (
            <div className="flex--column w-[90vw] md:w-[60vw] lg:w-[712px] modal--content" onClick={e => e.stopPropagation()}>
                ...
                <div className={`noscroll flex flex-col px-[32px] h-[225px] overflow-y-auto max-h-[500px]`}>
                    <div className="rounded-xl flex flex-col border border-[#2C3034] p-[32px]">
                        ...
                        <div className="flex flex-col lg:flex-row gap-3 justify-between items-center mt-[8px] mb-[12px]">
                            ...
                            <div className="p-[7px] gap-2 w-full h-[48px] bg-[#1E2023] border border-[#2C3034] rounded-lg font-semibold text-custom_gray_2 flex justify-start items-center font-sans" >
                                ...
                                <input type="number" step=".01"  min="0" placeholder="0.00"  value={coinsValue} onChange={handleCoinsChange} className="p-[3px] outline-0 w-full h-full w-[142px] bg-[#1E2023] border border-[#1E2023] rounded font-semibold text-base text-custom_gray_2 flex justify-center items-center font-sans" />
                            </div>
                        </div>
                        <span className="text-[#F03033] text-xs font-bold mb-[18px] ">1 SOL = ≈1.2 Coins</span>
