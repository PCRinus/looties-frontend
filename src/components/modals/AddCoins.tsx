...
const AddCoins = () => {
  ...
  const handleSolChange = (event: React.ChangeEvent<HTMLInputElement>) => {
    ...
    setSol(value);
    setCoins(value ? (parseFloat(value) * parseFloat(depositData!.tokenPerSolExchangeRate)).toFixed(3) : "");
  };

  const handleCoinsChange = (event: React.ChangeEvent<HTMLInputElement>) => {
    const value = event.target.value;
    setCoins(value);
    setSol(value ? (parseFloat(value) / parseFloat(depositData!.tokenPerSolExchangeRate)).toFixed(3) : "");
  };
  ...
  if (error) {
    ...
    //TODO: maybe add a loading spinner until deposit data is fetched
    return <></>;
  } else
    return (
      <div
      ...
      >
          ...
          <div className="">
            <div>
              <button className="active_modal top-[56-px] flex h-12 w-auto items-center justify-center rounded-xl border border-custom_gray_1 bg-custom_gray_1 px-[24px]">
                <span className="font-sans text-base font-semibold text-[#F03033]">Add coins</span>
              </button>
            </div>
          </div>
          <div className="">
            ...
            <div className="w-full">
              <div className="relative">
                <div className="relative inline-block w-full cursor-pointer">
                  ...
                  >
                    <li
                      className="flex h-12 cursor-pointer items-center justify-center bg-[#2C3034] px-4 py-2 font-sans text-base font-semibold text-[#F03033] hover:bg-gray-500 hover:text-white"
        ...
        <div className={`noscroll flex flex-col overflow-y-auto px-[32px] md:h-[225px] md:max-h-[500px]`}>
          <div className="flex flex-col rounded-xl border border-[#2C3034] p-[24px] md:p-[32px]">
            ...
            <div className="mb-[12px] mt-[8px] flex flex-col items-center justify-between gap-2 md:flex-row">
              ...
              <span className="block w-full md:hidden">
                <span className="block text-xs font-bold text-[#F03033] md:hidden ">
                  1 SOL = ≈{depositData!.tokenPerSolExchangeRate} Coins
                </span>
              </span>
            ...
            <span className="mb-[18px] hidden text-xs font-bold text-[#F03033] md:block ">1 SOL = ≈1.2 Coins</span>
