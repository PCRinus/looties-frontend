...
const WithdrawCoins = () => {
    ...
    return (
        <div className="flex--column w-[100vw] autoheight md:w-[712px] modal--content"    style={{ height: `calc(100vh - 144px)`, justifyContent: 'start' }}
                        ...
                        <div className="relative w-full">
                            <div className="relative inline-block cursor-pointer w-full">
                                ...
                                >
                                    ...
                                    <li className="px-4 py-2 h-12 text-[#F03033] bg-[#2C3034] text-base border-t-2 border-[#373A3D] font-sans flex items-center justify-center font-semibold cursor-pointer hover:bg-gray-500 hover:text-white" onClick={() => handleOptionChange('Withdraw coins')}>
                                        Withdraw coins
                                    </li>
            ...
            <div className={`noscroll flex flex-col px-[32px] md:h-[275px] overflow-y-auto md:max-h-[500px]`}>
                <div className="rounded-xl flex flex-col border border-[#2C3034] p-[24px] md:p-[32px]">
                    ...
                    <div className="flex flex-col md:flex-row  gap-3 justify-between items-center mt-[8px] mb-[12px]">
                        ...
                        <div
                            className="p-[7px] gap-2 w-full h-[48px] bg-[#1E2023] border border-[#2C3034] rounded-lg font-semibold text-custom_gray_2 flex justify-start items-center font-sans">
                        ...
                        <div
                            className="p-[7px] gap-2 w-full h-[48px] bg-[#1E2023] border border-[#2C3034] rounded-lg font-semibold text-custom_gray_2 flex justify-center items-center font-sans">
                            ...
                            />
                            <button
                                className="w-[68px] ml-auto h-full px-[8px] top-[56-px] bg-[#2C3034] border border-[#2C3034] rounded-xl flex justify-center items-center">
                    ...
                    <div
                        className="flex flex-row justify-between items-center text-[#F03033] text-xs font-bold mb-[18px]">
                        <span className="hidden md:flex basis-[53.5%] text-xs font-semibold ">1 SOL = ≈1.2 Coins</span>
                        <span className="flex basis-[46.5%] text-xs font-semibold ">
                          Estimated network fee is ${isNaN(parseFloat(sol)) ? "0.00" : (parseFloat(sol) / 100).toFixed(2)}
                        </span>
                    </div>
            ...
            <div
                className="flex flex-row footer bg-[#1A1D20] border-t-[1px] border-[#2C3034] justify-center items-center gap-5 px-8 py-4 rounded-b-[12px] mt-auto">
                <button
                    className="basis-[50%] h-[44.57px] px-[10px] bg-[#2C3034] rounded-lg font-semibold text-white flex justify-center items-center font-sans"
                    onClick={() => {
                ...
                <button
                    className="basis-[50%] leading-4 px-[10px] h-[44.57px] bg-gradient-to-t from-red-700 to-red-500 rounded-lg font-semibold text-white flex justify-center items-center font-sans"
