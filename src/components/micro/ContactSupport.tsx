  ...
  return (
    <>
      <div className="flex items-center rounded-xl bg-[#1A1D20] xs:mx-6 xs:h-[137px] xs:w-auto xs:flex-col  xs:justify-center xs:gap-4 2xl:h-20 2xl:w-full  2xl:flex-row 2xl:justify-between 2xl:gap-0 ">
        ...
        <button className="flex h-[44.57px] items-center justify-center gap-2 rounded-xl bg-gradient-to-t from-red-700  to-red-500 font-sans text-base font-semibold text-white xs:w-[90%] 2xl:mr-8 2xl:w-[206px]">
