  ...
  return (
    <div className={`${style} flex h-full w-full items-center justify-center ${className}`}>
      <div className=" flex-column">
        <span className=" font-sans font-bold text-custom_white_1 xs:ml-2 xs:text-[12px] 2xl:p-8 2xl:text-[16px]">
          {cardTitle}
        </span>
        <img src={icon} alt="icon-svg" className="mt-2 xs:w-[80px] 2xl:w-[148px]"></img>
        {coins && (
